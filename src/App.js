...
// const initialNodes = [
//   { id: '1',   sourcePosition: 'right' ,targetPosition: 'left',position: { x: 300, y: 50 }, data: { label: 'Research' ,  details: 'Research details here'} ,style: {background: '#EEB5EB'} , className: 'bold-label lavender' ,  },

//   { id: '2',  targetPosition: 'left',sourcePosition: 'right', position: { x: 550, y: 30 }, data: { label: 'External' ,  } ,style: {background: '#EEB5EB'} , className: 'bold-label lavender'},
//   { id: '16',  targetPosition: 'left',sourcePosition: 'right', position: { x: 800, y: 2 }, data: { label: 'B2C' } , className: 'bold-label lavender ' ,style: {background: '#EEB5EB'}},
//   { id: '17',  targetPosition: 'left',sourcePosition: 'right', position: { x: 800, y: 100 }, data: { label: 'B2C' } , className: 'bold-label lavender' ,style: {background: '#EEB5EB'} },

//   { id: '3',  targetPosition: 'left', position: { x: 550, y: 80 }, data: { label: 'Internal' } , className: 'bold-label lavender' ,style: {background: '#EEB5EB'}},
  
//   { id: '4', sourcePosition: 'right',targetPosition: 'left', position: { x: 300, y: 150 }, data: { label: 'Planning' } , className: 'bold-label blue' , style:{background: '#65DFF6'}} ,
//   { id: '8',targetPosition: 'left', position: { x: 550, y: 130 }, data: { label: 'PRD' }, className: 'bold-label blue' ,style:{background: '#65DFF6'}},
//   { id: '9',targetPosition: 'left', position: { x: 550, y: 180 }, data: { label: 'Specs' },  className: 'bold-label blue' , style:{background: '#65DFF6'}},

//   { id: '5', sourcePosition: 'right', targetPosition: 'left',position: { x: 300, y: 250 }, data: { label: 'Designing' }, className: 'bold-label brown' , style:{background:'#FAA300'}},
//   { id: '10', targetPosition: 'left', position: { x: 550, y: 230 }, data: { label: 'Hardware' } , className: 'bold-label brown',style:{background:'#FAA300'}},
//   { id: '11', targetPosition: 'left', position: { x: 550, y: 280 }, data: { label: 'Software' } , className: 'bold-label brown',style:{background:'#FAA300'}},

//   { id: '6', sourcePosition: 'right', targetPosition: 'left',position: { x: 300, y: 350 }, data: { label: 'Manufacturing' }, className: 'bold-label pink' ,style:{background:'#FFB5DA'} },
//   { id: '12',  targetPosition: 'left', position: { x: 550, y: 330 }, data: { label: 'Material' }, className: 'bold-label pink' ,style:{background:'#FFB5DA'} },
//   { id: '13',  targetPosition: 'left', position: { x: 550, y: 380 }, data: { label: 'Production' }, className: 'bold-label pink' ,style:{background:'#FFB5DA'} },

//   { id: '7', sourcePosition: 'right', targetPosition: 'left',position: { x: 300, y: 450 }, data: { label: 'Sales/Marketing' } , className: 'bold-label green' , style: {background: '#C8DF52'}},
//   { id: '14',  targetPosition: 'left', position: { x: 550, y: 430 }, data: { label: 'Online' }, className: 'bold-label green' , style: {background: '#C8DF52'}},
//   { id: '15',  targetPosition: 'left', position: { x: 550, y: 480 }, data: { label: 'Dealership' } , className: 'bold-label green' ,style: {background: '#C8DF52'}},
...
//   { id: '19', targetPosition: 'left' ,sourcePosition: 'right' , position: { x: 1000, y: 2 }, data: { label: 'Online' }, className: 'bold-label lavender' ,style: {background: '#EEB5EB'}},
//   { id: '20', targetPosition: 'left' , sourcePosition: 'right', position: { x: 1000, y: 60 }, data: { label: 'Interview' }, className: 'bold-label lavender' ,style: {background: '#EEB5EB'}},
//   { id: '21', targetPosition: 'left',sourcePosition: 'right' , position: { x: 1000, y: 120 }, data: { label: 'Public Data' }, className: 'bold-label lavender',style: {background: '#EEB5EB'} },
//   { id: '22', targetPosition: 'left',sourcePosition: 'right' , position: { x: 1000, y: 180 }, data: { label: 'Health' }, className: 'bold-label lavender' ,style: {background: '#EEB5EB'}},
...
//   { id: '5', source: '5', target: '11' },
//   { id: '6', source: '6', target: '12' },
//   { id: '6', source: '6', target: '13' },
//   { id: '7', source: '7', target: '14' },
//   { id: '7', source: '7', target: '15' },
//   { id: '2', source: '2', target: '16' },
//   { id: '2', source: '2', target: '17' },
//   { id: '18', source: '18', target: '1' },
//   { id: '18', source: '18', target: '4' },
//   { id: '18', source: '18', target: '5' },
//   { id: '18', source: '18', target: '6' },
//   { id: '18', source: '18', target: '7' },
//   { id: '17', source: '17', target: '19' },
//   { id: '17', source: '17', target: '20' },
//   { id: '17', source: '17', target: '21' },
//   { id: '17', source: '17', target: '22' },
//   { id: '19', source: '19', target: '23' },
//   { id: '20', source: '20', target: '23' },
//   { id: '21', source: '21', target: '23' },
...
//   return (
//     <div style={{ width: '100vw', height: '95vh', marginTop: 10 , marginBottom:10 }}>
...
export default function App() {
  ...
  const handleNodeMouseEnter = (event, node) => {
    if (node.data && Array.isArray(node.data.details))  {
      console.log(popupData , "Rushdiya")
      ...
      console.log(showPopup , "POP UP")
      setShowPopup(true);
      console.log(showPopup, "poppppppp")
    }
  };
  ...
  return (
    <div  style={{ width: '100vw', height: '97vh', marginTop: 10 , marginBottom:10 }}>
      ...
      />
      {showPopup && (
        <div className="popup" style={{ position: 'absolute', top: popupData.position.y, left: popupData.position.x, backgroundColor: popupData.background, padding: 10, border: '1px solid black' , borderRadius:5 }}>
        <h3 style={{ marginTop: 0 , paddingTop:0 , fontSize:18 , fontWeight:600}}>{popupData.label}</h3>
